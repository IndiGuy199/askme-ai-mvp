-- ============================================================
-- Migration: Goal/action baseline snapshots + swap history + richer action logs
-- Created: 2026-02-11
-- Purpose:
--   - Capture "starting point" when user activates/swaps a goal or action
--   - Keep swap/event history for analytics + AI insights
--   - Add optional high-signal fields to action_completions
-- ============================================================
...
-- 5) Enrich action_completions with optional high-signal fields
